-- What is the species makeup of trees WITHOUT harvest codes at obs1?
...
-- grab the species code for each tree WITHOUT harvest codes at obs1
SELECT
	spcd, 
...
AND CASE WHEN (tyt.trtcd1 = 10 OR tyt.trtcd2 = 10 OR tyt.trtcd3 = 10) THEN false ELSE true END -- only grab trees NOT harvested on obs1
GROUP BY spcd
