...
individual_trees AS (
	...
	SELECT *
	FROM unfiltered_trees unft
	WHERE tree_status_sequence[1] = 1
		AND tree_status_sequence[ARRAY_LENGTH(tree_status_sequence, 1)] = 2
)
...
JOIN individual_trees it
ON it.tree_plt_cn_sequence[1] = ANY(hmop.cn_sequence)
