...
# set up model
am_model = smf.mixedlm("growth_per_year ~ harvested_on_obs1", am_growth, groups=am_growth["unique_subp"])
...
# set up model
em_model = smf.mixedlm("growth_per_year ~ harvested_on_obs1", em_growth, groups=em_growth["unique_subp"])
