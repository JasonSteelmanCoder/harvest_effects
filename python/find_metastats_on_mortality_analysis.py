...
ax1.axvline(mean_t1_timespan, color='red', linestyle="--", label=f"Mean: {round(mean_t1_timespan, 2)}")
ax1.legend()
...
ax2.axvline(mean_t2_timespan, color='red', linestyle='--', label=f"Mean: {round(mean_t2_timespan, 2)}")
ax2.legend()
...
plt.axvline(mean_total_timespan, color='red', linestyle="--", label=f"Mean: {round(mean_total_timespan, 2)}")
plt.legend()
plt.show()
